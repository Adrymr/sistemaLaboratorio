   ...
   // Cabecera de página
    function Header()
    {
      ...
      //color
        ...
        $this->Cell(100, 10, utf8_decode("REPORTE DE ORDENES DE COMPRA PROCESADAS"), 0, 1, 'C', 0);
        $this->Ln(7);
...
$query = $conn->query('SELECT * FROM purchase_orders JOIN suppliers WHERE id_supplier = suppliers.id AND estatus = "procesada"');
