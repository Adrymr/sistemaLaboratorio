   ...
   // Cabecera de página
    function Header()
    {
      ...
      //color
        ...
        $this->Cell(100, 10, utf8_decode("REPORTE DE PRODUCTOS EN PRODUCCION"), 0, 1, 'C', 0);
        $this->Ln(7);
      ...
      $this->SetDrawColor(163, 163, 163); //colorBorde
        ...
        $this->Cell(150, 10, utf8_decode('Ingredientes'), 1, 0, 'C', 1);
...
$query = $conn->query('SELECT * FROM products WHERE id_dpt = 1');

while ($data = $query->fetch_object()) {     
   /* TABLA */
    $pdf->Cell(10, 10, utf8_decode($i), 1, 0, 'C', 0);
    $pdf->Cell(20, 10, utf8_decode($data->code), 1, 0, 'C', 0);
    $pdf->Cell(50, 10, utf8_decode($data->name), 1, 0, 'C', 0);
    $pdf->Cell(150, 10, utf8_decode($data->ingredients), 1, 0, 'C', 0);
    $pdf->Cell(20, 10, utf8_decode($data->price), 1, 0, 'C', 0);
    $pdf->Cell(20, 10, utf8_decode($data->quantity), 1, 1, 'C', 0);
