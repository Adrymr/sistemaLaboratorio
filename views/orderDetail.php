...
if(isset($_SESSION['name']) && !empty($_GET['id'])){
    ...
    $total = 0;
    $totalC = 0;
    $querya = "SELECT * FROM `products` WHERE id_dpt = 1";
    $rs = mysqli_query($conn, $querya) or die("Error: " . mysqli_error($conn));
                    ...
                    <div class="container-fluid px-4">
                            ...
                            <div class="card mb-4">
                                <form action="#" method="post">
                                    ...
                                    <div class="form-floating mb-3">
                                        <select class="form-select form-control" name="product" aria-label="Default select example" required>
                                        <option></option>
                                            <?php 
                                    ...
                                    <div class="d-flex align-items-center justify-content-between mt-4 mb-0">
                                        <input type="submit" name="btn-add" value="Agregar" class="btn btn-primary">
                                    </div>
                                </form>
                            </div>
                            ...
                            <div class="card mb-4">
                                ...
                                if(isset($_POST['product']) && isset($_POST['quantity'])){
                                    ...
                                    $queryp = "SELECT * FROM products WHERE id= '$id_prod'"; 
                                    $rsp = mysqli_query($conn, $queryp) or die("Error: " . mysqli_error($conn));
                                    $datap = mysqli_fetch_array($rsp);

                                    if( $quty > $datap['quantity']){
                                        echo "<div class='card mb-4'><h5>No hay stock suficiente</h5></div>";
                                    }else{

                                        if(isset($_SESSION['list1']) && isset($_SESSION['list2']) && isset($_SESSION['list3'])  && isset($_SESSION['list4'])){

                                            array_push($_SESSION['list1'], $datap['name']);
                                            array_push($_SESSION['list2'], $datap['price']);
                                            array_push($_SESSION['list3'], $quty);
                                            array_push($_SESSION['list4'], $datap['code']);
                                            array_push($_SESSION['list5'], $datap['id']);
                            ...
                            <div class="card mb-4">
                                <h3 class="mt-4"> Total del Pedido: <?php echo $total?></h3>

                                <form action="#" method="post">
                                <div class="d-flex align-items-center justify-content-between mt-4 mb-0">
                                    <input type="submit" name="btn-orden" value="Registrar Pedido" width="150px" class="btn btn-primary">

                                    <input type="submit" name="btn-cancel" value="Cancelar Pedido" width="150px" class="btn btn-primary">
                                </div>
                                </form>
                            </div>
                            ...
                            if(isset($_POST['btn-orden'])){
                                ...
                                for ($i=0; $i<count($_SESSION['list1']); $i++){
                                   ...
                                   $totalC += $_SESSION['list2'][$i] * $_SESSION['list3'][$i];
                                    ...
                                    $query4 = "INSERT INTO order_detail (id_prod, cod_prod, quantity, price, id_order) VALUES ('$id_prod', '$code','$quantity','$price','$idOrder')"; 
                                    $rs4 = mysqli_query($conn, $query4) or die("Error: " . mysqli_error($conn));
                                }
                                
                                $query5 = "UPDATE orders SET total='$totalC' WHERE id = '$idOrder'"; 
                                ...
                                $query6 = "DELETE FROM orders WHERE id='$idOrder'";
