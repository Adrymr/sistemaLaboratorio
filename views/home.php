                            ...
                            <div class="">
                                <div class="card mb-4">
                                    ...
                                    let lineChart = new Chart(CHART, {
                                        type: "line",
                                        data: {
                                            labels: [<?php echo '"'.implode('","',  $product ).'"' ?>],
                                            datasets: [{
                                                label: 'Gráfica los productos más producidos',
                                                data: [<?php echo '"'.implode('","',  $quantity ).'"' ?>],
                                                fill: false,
                                                borderColor: 'rgb(0, 128, 8)',
                                                tension: 0.1,
