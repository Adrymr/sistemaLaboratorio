            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                            ...
                            <div class="card mb-4">
                                <br>
                                <h4>Selecciona el proveedor</h4>
                                <br>
                                <form action="#" method="post">
                                <div class="form-floating mb-3">
                                        <select class="form-select form-control" name="supplier" aria-label="Default select example" required>
                                        <option></option>
                                            <?php 
                                            while ($data = mysqli_fetch_array($rs)) {
                                                echo "<option value='".$data['id']."'>".$data['nameS']."</option>";
                                            }
                                            ?>
                                        </select>
                                        <label for="inputType"><i class="fa-solid fa-user"></i> Proveedor</label>
                                    </div>
                            ...
                            <div class="card mb-4">
                                ...
                                if(isset($_POST['supplier'])){
                                    ...
                                    $query2 = "INSERT INTO purchase_orders (id_supplier, total, estatus) VALUES ('$id_sup', 0, 'En Proceso')";
                                    $result2 = mysqli_query($conn, $query2) or die(mysqli_error($conn));
                                    
                                    $query3 = "SELECT id FROM purchase_orders WHERE id_supplier = '$id_sup' AND total = 0"; 
                                ...
                                if(!empty($idOrder)){
                                    ...
                                    <a href="purchaseOrderDetail.php?id=<?php echo $idOrder;?>" class="btn btn-small btn-primary"> Siguiente</a>
                                    </div>
                                <?php
                                }
                                ?>
